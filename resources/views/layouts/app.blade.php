...
<head>
    ...
    <meta content="Sistem Reservasi Konsultasi Berbasis Web" name="description" />
    <title>Sistem Reservasi | Halaman Akses</title>

    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/images/icon-customer-service.png') }}">
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Sistem Reservasi Berbasis Web.
                        </div>
                        <div class="col-sm-6">
